        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-5">
              ...
              {selectedEmployee && selectedFormType && !selectedFormType.applicableSystems.includes(selectedEmployee.retirementPlan) && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 flex items-start gap-2">
                  <AlertCircle className="h-4 w-4 text-yellow-600 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-yellow-800">
                    {selectedFormType.formNumber} is for {selectedFormType.applicableSystems.join(' / ')} employees.{' '}
                    {selectedEmployee.firstName} {selectedEmployee.lastName} is enrolled in {selectedEmployee.retirementPlan}.
                    {' '}Please select a different form or employee.
                  </p>
                </div>
              )}
            ...
            <div className="flex items-center justify-end gap-3 p-6 border-t border-neutral-200">
              ...
              <button
                ...
                disabled={!selectedEmployee || generating || (selectedEmployee && selectedFormType && !selectedFormType.applicableSystems.includes(selectedEmployee.retirementPlan))}
              >
                {generating ? (
                  <>
